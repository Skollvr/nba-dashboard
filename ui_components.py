    ...
    with visual_tab:
        ...
        if active_col in log.columns:
            ...
            if not hist_data.empty:
                ...
                fig.update_xaxes(title=f"{visual_metric} por jogo", showgrid=True, gridcolor="rgba(148,163,184,0.1)")
                fig.update_yaxes(title="Quantidade de jogos", showgrid=True, gridcolor="rgba(148,163,184,0.1)")
